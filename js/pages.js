var uv     = { main : [new THREE.Vector2(0, .875), new THREE.Vector2(.125, .875), new THREE.Vector2(.125, 1),new THREE.Vector2(0, 1)],
               website : [new THREE.Vector2(.125, .875), new THREE.Vector2(.250, .875), new THREE.Vector2(.250, 1),new THREE.Vector2(.125, 1)],
               contact : [new THREE.Vector2(.250, .875), new THREE.Vector2(.375, .875), new THREE.Vector2(.375, 1),new THREE.Vector2(.250, 1)],
               me : [new THREE.Vector2(.250, .875), new THREE.Vector2(.375, .875), new THREE.Vector2(.375, 1),new THREE.Vector2(.250, 1)],
               projects : [new THREE.Vector2(.250, .875), new THREE.Vector2(.375, .875), new THREE.Vector2(.375, 1),new THREE.Vector2(.250, 1)]
};

var bkgMain = THREE.ImageUtils.loadTexture( 'img/bkg/bkg1.png' );
var bkgWebsite = THREE.ImageUtils.loadTexture( 'img/bkg/bkg3.png');
var bkgContact = THREE.ImageUtils.loadTexture( 'img/bkg/bkg2.jpg');
